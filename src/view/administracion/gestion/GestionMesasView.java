...
public class GestionMesasView extends JFrame {
	 ...
	 * @param tableModel 
	 */
	public GestionMesasView(TableModel tableModel) {
		//jFrame
		...
		//btnCrear
		btnCrear = new JButton("CREAR mesa");
		...
		//editLabels
		lblEdit = new JLabel("EDITAR MESA");
		...
		//lblEditSeleccion
		lblEditSeleccion = new JLabel("No hay ninguna mesa selecionada en la tabla");
